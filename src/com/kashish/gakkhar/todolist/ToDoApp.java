package com.kashish.gakkhar.todolist;
...
class Task extends JPanel {
    ...
    Task() {
        ...
        taskName.setBackground(pink); // set backg
        //round color of text field
...
class Footer extends JPanel {
    ...
    Footer() {
        ...
        addTask.setFont(new Font("Cairo", Font.ITALIC, 20)); // set font
        ...
        clear = new JButton("Clear Finished Tasks"); // add clear button
        clear.setFont(new Font("Cairo", Font.ITALIC, 20)); // set font
...
class TitleBar extends JPanel {
    ...
    TitleBar() {
        ...
        titleText.setFont(new Font("Anton", Font.BOLD, 28)); // Font of the text
